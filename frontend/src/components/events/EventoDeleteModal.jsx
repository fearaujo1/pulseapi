                ...
                <div className="flex items-start justify-between px-8 pt-8">
                    <div>
                        ...
                        <p className="mt-2 text-[13px] text-slate-500">
                            Confirme a exclusão desta ocorrência
                        </p>
                    </div>
                ...
                <div className="px-8 pb-8 pt-6">
                        ...
                        <div className="flex gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-2 text-[13px] text-red-700/90">
                                    A ocorrência será removida do histórico de eventos.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    {evento && (
                        <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-5">
                            <p className="text-[13px] text-slate-500">Ocorrência selecionada</p>
                            ...
                            <p className="mt-1 text-[13px] text-slate-600">
                                Equipamento: {evento.equipamentoNome || "-"}
                            </p>
                    ...
                    <div className="mt-8 flex justify-end gap-3">
                        ...
                        >
                            {loading ? "Excluindo..." : "Excluir Ocorrência"}
                        </button>
                    </div>
                </div>
            </div>
...
export default EventoDeleteModal;